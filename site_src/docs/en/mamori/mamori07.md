...
- the fourth ![3m](../../hai/man3.gif) when all four copies of ![4m](../../hai/man4.gif) are visible, so it can only hit a penchan wait
...
Once you no longer have comfortably safe tiles,
the next tier is to look for tiles that **can only hit shanpon or tanki waits**.
...
There is also one very basic but important principle:
**delay cutting yakuhai as much as possible.**
...
<div class="page-nav" markdown="0">
  <a class="page-nav__link page-nav__link--prev" href="mamori06.html">Previous: Folding Procedure (1)</a>
  <a class="page-nav__link page-nav__link--next" href="mamori08.html">Next: Folding Procedure (3)</a>
</div>
<!-- PAGE NAV END -->
