...
<span class="green">
Do not force a Chiitoitsu tenpai<br />
into Toitoi.
</span>
...
<span class="green">
Terminals and honors are easy to call.<br />
...
<span class="green">
If all of the following are true:<br />
・you have pairs that are easy to call<br />
・you can expect at least 3900 points<br />
・the hand is still early<br />
<br />
...
<span class="green">
If you already have one concealed triplet,<br />
keep both Chiitoitsu and Toitoi available,<br />
