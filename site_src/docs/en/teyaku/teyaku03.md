...
<span class="green">If the final point value is the same, a guaranteed yaku is better than an uncertain one.</span>
...
<span class="b">In modern mahjong, first-call yakuhai is the default.</span>
...
<span class="green">There are usually only two times to wait for the second call on yakuhai: when your hand is very good, or when your hand is very bad.</span>
...
<div class="page-nav" markdown="0">
  <a class="page-nav__link page-nav__link--prev" href="teyaku02.html">Previous Page: Thinking About Yaku (2)</a>
  <a class="page-nav__link page-nav__link--next" href="teyaku04.html">Next Page: Pinfu</a>
</div>
<!-- PAGE NAV END -->
