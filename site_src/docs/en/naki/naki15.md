...
So the best move is to call <img src="../../hai/pin7.gif" width="24" height="34"> only to erase ippatsu, then begin folding by breaking the concealed triplet of <img src="../../hai/haku.gif" width="24" height="34">.
...
1. You must have enough safe tiles to fold out completely.
2. You must not be in danger of being overtaken by the player in last.
...
<div class="page-nav" markdown="0">
  <a class="page-nav__link page-nav__link--prev" href="naki14.html">Previous: Calling Techniques (2)</a>
  <a class="page-nav__link page-nav__link--next" href="../reach/index.html">Next Chapter: Riichi</a>
</div>
<!-- PAGE NAV END -->
