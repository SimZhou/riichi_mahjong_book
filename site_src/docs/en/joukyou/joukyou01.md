...
Table info: ![3p](../../hai/pin3.gif) **three copies are already visible**

In that case, you would keep the penchan instead.

To go even further, from this hand it could also be completely correct to cut ![3m](../../hai/man3.gif) or ![4s](../../hai/sou4.gif).

And if it were haitei, it goes without saying that you should discard the safest tile.  
If ![3m](../../hai/man3.gif) is guaranteed to pass, then you simply cut ![3m](../../hai/man3.gif).
...
<span class="red">table situation</span> and <span class="red">score situation</span>
...
<span class="red">strategy comes first</span>.

![1m](../../hai/man1.gif)![6m](../../hai/man6.gif)![7m](../../hai/man7.gif)![9m](../../hai/man9.gif)![9m](../../hai/man9.gif)![8p](../../hai/pin8.gif)![1s](../../hai/sou1.gif)![4s](../../hai/sou4.gif)![9s](../../hai/sou9.gif)![east](../../hai/ton.gif)![south](../../hai/nan.gif)![west](../../hai/sha.gif)![white](../../hai/haku.gif)![chun](../../hai/tyun.gif)
...
- If you are far behind in last place, you might keep both Kokushi and Honitsu in mind and start by dealing with tiles like ![4s](../../hai/sou4.gif).
