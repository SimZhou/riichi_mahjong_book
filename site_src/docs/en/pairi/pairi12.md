...
At two-shanten, some hands do not belong to the two basic patterns covered on the previous pages.

When that happens, first identify which of these three cases you are in:

- four taatsu plus a floating tile
- headless
- a hand that can still move toward Chiitoitsu

Once the shape is classified correctly, the discard choice becomes much easier.
