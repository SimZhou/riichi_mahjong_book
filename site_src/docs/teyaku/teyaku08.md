...
比起“刻意去做出三色”，  
我觉得三色同顺更重要的，其实是“不要漏看三色”。  
先把最基本的手筋记住就够了。

## 1. 滑移

为了让牌变成三色，  
把万子、筒子、索子的各组面子朝同一个数字带去滑动，  
就是三色的基本。
...
先用一个简单的例子来看。例 1 现在是平和一向听，

这时如果摸到 <img src="../hai/pin6.gif" width="24" height="34"> ，就和 <img src="../hai/pin3.gif" width="24" height="34"> 交换，变成 456 三色的一向听。
...
同样地，如果摸到 <img src="../hai/pin2.gif" width="24" height="34"> ，也和 <img src="../hai/pin5.gif" width="24" height="34"> 交换。
...
这手如果重视受入宽度，打筒子更宽，  
但本手应当是切 <img src="../hai/sou7.gif" width="24" height="34"> 。
...
这样一来，678 和 789 两种三色都还能狙击。  
这种打法就叫“把三色放在天秤上”，也叫“两天秤打法”。
...
正解是切 <img src="../hai/man2.gif" width="24" height="34"> 。
...
如果顺利摸到 <img src="../hai/man3.gif" width="24" height="34"> ，就能看出留下那张 <img src="../hai/man2.gif" width="24" height="34"> 的价值。

只要善于利用余牌，就会出现非常多可以顺手做成手役的模式。
...
看上去最没用的是 <img src="../hai/sou2.gif" width="24" height="34"> ，但它其实是 123 的种子。

这里最好应当切 <img src="../hai/pin1.gif" width="24" height="34"> 。
